...
const FEATURE_CARDS: FeatureCardData[] = [
  {
    ...
    subtitle: '114 Surahs',
    description: 'Explore the divine revelation with translations, transliterations, and beautiful recitations from renowned Qaris.',
    icon: 'book',
  ...
  },
  {
    ...
    subtitle: 'Islam & Iman',
    description: 'Understand the 5 Pillars of Islam and 6 Pillars of Iman with comprehensive explanations and reflections.',
    icon: 'compass',
  ...
  },
  {
    ...
    description: 'Learn and memorize the beautiful names of Allah with meanings, benefits, and audio pronunciations.',
    icon: 'heart',
...
export const WebDashboardContent: React.FC<WebDashboardContentProps> = ({
  ...
  return (
    ...
    >
      ...
      <View style={[styles.featureCardsGrid, isWide && styles.featureCardsGridWide]}>
