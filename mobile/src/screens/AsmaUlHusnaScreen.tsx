...
export const AsmaUlHusnaScreen: React.FC = () => {
  ...
  const namesQuery = useQuery({
    ...
    queryFn: () => asmaUlHusnaService.getNames(),
  });
  ...
  if (namesQuery.isError) {
    const message =
      (namesQuery.error as any)?.message ||
      ...
      >
        <View style={styles.headerCard}>
          ...
          <Text style={styles.headerSubtitle}>
            The beautiful names of Allah. Tap the speaker icon to hear the pronunciation.
          </Text>
        </View>
